...
function get_hsf(ut,str,col_id) {
    ...
    xhttp.open("GET", "./php/call_functions.php?x=get_hsf&ut=" + ut, true);
    xhttp.send();
}

function print_hsf_today(ut) {
    ...
    xhttp.open("GET", "../php/dompdf-2.0.1/convert.php?x=print_hsf_today&ut="+ut, true);
    xhttp.send();
}